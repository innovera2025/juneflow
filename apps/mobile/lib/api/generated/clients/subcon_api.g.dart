...
class _SubconApi implements SubconApi {
  _SubconApi(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<Entity> createSubconContract({required Entity body}) async {
    final _extra = <String, dynamic>{};
  ...
  Future<Entity> deliverPeriod({
    required String id,
    required PeriodsIdDeliverRequestBody body,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  Future<Entity> inspectPeriod({
    required String id,
    required PeriodsIdInspectRequestBody body,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<Entity> approvePeriodPayment({required String id}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  Future<Entity> fixDefect({
    required String id,
    required DefectsIdFixRequestBody body,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  Future<Entity> recheckDefect({
    required String id,
    required DefectsIdRecheckRequestBody body,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
