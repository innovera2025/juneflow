...
//     assumed: every stub in apps/api today uses the literal shape (the scan finds 36
//     doors across 36 files, and the believability floor below fails if that collapses).
...
//     that it models a throw identically. A `then: () => Promise.resolve([])` that
