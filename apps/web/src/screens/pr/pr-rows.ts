 ...
 * also shows `title` (รายละเอียด), `vendor`, `requester` (ผู้ขอ), `phase` (ตำแหน่งงาน),
...
/** KPI "value in millions", 2 dp (pr-list.jsx KPI sub "มูลค่า {value} M ฿"). */
...
/** Count of the active filter selects for the "กรอง · {count}" button badge. */
