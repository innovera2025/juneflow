...
> **QUEUE EMPTY (2026-07-20 · PHASE-4 META-1 enrich PROMOTED → main `3f6b841` · 0-drift · pin ecf179e)** — P2-BE-43 promoted, moved to history. Next batch = chat-3 web (subcon.accept/pm.dashboard/pm.schedule/pm.wo) after reconcile. The `>` records below are the durable promote history.
