...
| P0-MOB-04 | mobile | ready | mobile screen inventory — `pototype/mobile*.jsx` (**26 จอ distinct + host** — คำตัดสิน B-015 ก) → ตาราง widget mapping + ภาพอ้างอิง gallery mobile ต่อจอ → เก็บที่ `apps/mobile/docs/screen-map.md` (เตรียม Phase 4) | — | ครบ 26 จอ distinct + host · review โดย Wei | 3 ชม. |
...
| id | เขต | สถานะ | spec pointer | dependencies | gates ที่ต้องผ่าน | ประมาณเวลา |
|---|---|---|---|---|---|---|
| P0-DEV-01 | devops | done | `infra/docker-compose.yml` (dev) — pg16 + redis + api + web + worker · **`docker compose up` เดียวได้ระบบ + seed** (Manifest กลุ่ม 5 ข้อกำหนด Phase 0) | P0-BE-10, P0-BE-13 | compose up สำเร็จรอบเดียว + seed ครบ + คลิกเทียบ gallery ได้ | 3 ชม. |
