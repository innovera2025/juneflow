...
| P0-INT-05 | integrations | review | field inventory ฟอร์มภาษีไทยจาก `pototype/tax-forms.jsx` → `packages/tax-engine/docs/tax-forms-map.md` (เตรียม Phase 3 — ฟอร์มต้อง render ตรง tax-forms.jsx / accurate to RD originals) | — | ครอบคลุมทุกฟอร์มใน tax-forms.jsx · review โดย Wei | 3 ชม. |
