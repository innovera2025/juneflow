...
| P0-BE-14 | backend | review | กลไก feature flag ซ่อนโมดูลที่ยังไม่เสร็จ — dev เขียว/demo ได้ตลอด (Manifest กลุ่ม 5 ข้อกำหนด Phase 0) | P0-BE-13 | G3 (flag gating) + CI เขียว | 2 ชม. |
