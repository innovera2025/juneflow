...
| P0-QA-02 | qa | review | contract test harness (`tests/contract/`) — generate จาก `openapi.yaml` · **expected จาก contract เท่านั้น ห้ามอ่าน implementation ก่อน** (กลุ่ม 2.4) | P0-BE-12 | G2 harness รันได้กับ dev API | 3 ชม. |
