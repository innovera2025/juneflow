...
| P0-QA-06 | qa | doing | seed fixture assertions จาก `docs/extract/MOCK-DATA.md` §สรุป — จำนวน record ต่อ entity เป็น expected (รันจริงเมื่อ P0-BE-10 done) | — | assertions ตรง §สรุป 100% | 2 ชม. |
