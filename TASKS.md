...
| P0-PLAT-02 | platform | ready | **tokens/i18n ownership (แทน B-011):** ตรวจ `packages/tokens` + `packages/i18n` build/typecheck/test เขียว + เป็นเจ้าของการเปลี่ยนแปลงต่อไป (BE-04/05 ทำ implementation แล้ว — platform ดูแลต่อ) · ห้ามแก้ `i18n-full.json` (sacred) | — | tokens/i18n gates เขียว | 1 ชม. |
