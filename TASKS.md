...
| P0-FIX-04 | qa | review | **QA-04 audit:** ช่องผ่านปลอมของ G5 — ภาพที่ขนาด**ใหญ่กว่า** reference PASS เงียบ (ขัด claim auto-FAIL) · แก้ `tests/visual/lib/compare.ts` (size-mismatch → FAIL ทุกทิศ) — **ก่อนจอจริง WEB-05** | — | G5 self-check: size-larger = FAIL | 1 ชม. |
