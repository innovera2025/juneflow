...
| P0-BE-10 | backend | review | seed จาก `docs/extract/MOCK-DATA.md` §สรุป — normalize FK ข้อความ → `*_id` จริง · apply C3 (map state) · C6 (VENDOR_SEED จาก master-party.jsx) · C9 (JV lines DR=CR) · C10 (ห้าม hardcode badge) · **blocked B-009**: §สรุป ระบุ Unit/SalesUnit = "ไม่มี record (generate 84 ยูนิตทุก reload)" แต่ §0 กฎ 3 ห้ามลอก generator runtime — จำนวน Unit ที่ต้อง persist (84/0) คือคำถาม "84 vs 0 ห้ามตัดสินเอง" เดียวกับที่ diff-reviewer FAIL P0-QA-06 · gate "counts ตรง §สรุป" ครอบ Unit → seed สมบูรณ์ไม่ได้จนกว่า Wei ตอบ B-009 · **B-009 ตอบแล้ว (ก): persist SalesUnit 84 records ตาม generator** — อัปเดต expected ใน tests/seed ด้วย (todo ผูก B-009) · **REWORK — ด่าน 4.5 FAIL (เนื้อหาไม่ถอดจาก mock):** (1) transcribe mock rows จริงจาก .jsx ต้นทางทุก entity ธุรกรรม (BOQ groups/items ชื่อ-qty-ราคาจริงจาก boq.jsx · PR สถานะครบ draft/revise/rejected จาก pr-list.jsx · timeline จาก timeline.jsx · lead 4/2/2/1/1 · bank 8 บรรทัด reconcile · BOM 17 lines B-1 · checklist items จริง · workers/inventory/documents/audit/petty/fa ชื่อจริง) (2) JV ใช้ยอด+บรรทัด mock จริงจาก gl.jsx (7 ใบ 17 lines เลข JV-2026-0412..0418) — C9 (3) work_period โครง 4/4/3/5 + rejected 1 งวดพร้อม defect ตาม subcon-accept.jsx — C3 (4) สร้าง project_node kind=unit B-01..B-84 ให้ sales_unit ชี้รายตัว — B-009(ก) code ต้อง persist (5) เติม defect_report 3 (6) REPORT_DERIVED ครอบทุกบรรทัด §สรุป ที่ข้าม (7) ส่วนที่ติด blocker ใหม่: B-021 trial · B-022 tenant 9 vs 3 · B-023 subcon vendors — คง mapping เดิม + comment อ้าง blocker ห้าม assert final ถ้ายังไม่มีคำตอบ / ใช้คำตอบทันทีถ้ามีใน BLOCKERS.md แล้ว | P0-BE-09 | seed รันผ่าน + จำนวน record ตรง §สรุป + persist (ไม่ reseed ทุก reload) | 3 ชม. |
