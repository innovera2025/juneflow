...
| P0-QA-03 | qa | blocked | Playwright E2E harness (`tests/e2e/`) + smoke test (login → shell load) ตาม state machine ใน `docs/handoff/flows.html` · **blocked B-034: e2e smoke ต้องมี login+shell UI (P0-WEB-05, Phase 1) — apps/web ยังเป็น Placeholder scaffold**| P0-DEV-01 | G4 smoke ผ่านบน compose dev | 3 ชม. |
