...
| P0-BE-07 | backend | ready | schema กลุ่มโครงการ/BOQ/จัดซื้อ ตาม dictionary (+คำตัดสิน C2: basis ที่ 4 = `unit`, C3: WorkPeriod states ตาม flows/dictionary) · **REWORK (ด่าน 4.5 FAIL 12 ก.ค.):** ต้องเพิ่ม `pm_quote` ตาม erd (§6 นับ erd เป็น base) — งานส่วนอื่นเสร็จบน feature/backend แล้ว (C2/C3 ผ่าน) | P0-BE-06 | G1 (บางส่วน) + migration check | 3 ชม. |
