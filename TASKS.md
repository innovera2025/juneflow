...
| P0-BE-14 | backend | ready | กลไก feature flag ซ่อนโมดูลที่ยังไม่เสร็จ — dev เขียว/demo ได้ตลอด (Manifest กลุ่ม 5 ข้อกำหนด Phase 0) · **REWORK (ด่าน 4.5 FAIL):** (1) 404 body ต้อง flat {code,message} ตรง contract + แก้ test (2) GET /feature-flags ไม่มีใน contract → B-018 รอ Wei — แนะนำถอด endpoint ชั่วคราว (ค) (3) normalize 401 ของ tenant-scope.ts เป็น flat ด้วย | P0-BE-13 | G3 (flag gating) + CI เขียว | 2 ชม. |
