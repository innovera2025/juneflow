...
| P0-BE-09 | backend | review | schema ส่วนขยายบังคับ **ภาคผนวก B** ครบ 14 รายการ (PLAN.md ภาคผนวก B + `docs/extract/MOCK-DATA.md`) | P0-BE-06, P0-BE-07, P0-BE-08 | **G1 เต็ม** = dictionary + ภาคผนวก B ครบ | 3 ชม. |
