...
| P0-BE-12 | backend | ready | `packages/contracts` — `openapi.yaml` จาก `docs/handoff/api-contract.md` + codegen TS (Dart pipeline ดู P0-MOB-03) · **sacred หลัง merge — แก้ผ่าน Wei เท่านั้น** · ปลดล็อกแล้ว (B-012 ตอบ ก — orchestrator รันรอบพิเศษพร้อม override) | P0-BE-01, P0-BE-02 | contract lint + codegen ผ่าน | 3 ชม. |
