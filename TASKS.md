...
| P0-FIX-05 | backend | ready | **BE-10 seed refinements (late-answered blockers):** (1) **B-025(ก)** platform_invoice → 3 แถว INV-SUB-* ของ T-1001 ตัด PINV-2569-0610 (2) **B-026(ก)** flag subcon = 6 (SUBCONS เท่านั้น) reclassify V-0031/V-0045 → supplier · **หมายเหตุ directive: จัดตำแหน่ง SC-07 (คู่สัญญาจาก subcon-accept) + rewire `wos` ที่ FK ไป vendor subcon เดิม** (reviewer flag) (3) B-029 pr_type clear รอ Wei · seed comment แก้ cite B-025→B-029 | P0-BE-10 | seed รัน + count ตรงหลัง refinement (subcon 6, invoice 3) | 2 ชม. |
