...
| P0-BE-13 | backend | review | Fastify app skeleton — AuditLog middleware (ทุก mutation) · quota → `402 QUOTA_EXCEEDED` + `upgrade_url` · `POST /files` presigned skeleton (R2, fake ใน dev) · BullMQ worker skeleton · health endpoint (PLAN.md §5) | P0-BE-11, P0-BE-12 | G2 (endpoints ที่มีใน contract) + G3 (audit/quota) | 3 ชม. |
