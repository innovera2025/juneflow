...
| P0-QA-04 | qa | review | visual gate harness — screenshot compare กับ `tests/visual/reference/` ตามเกณฑ์ PLAN.md §0 (ต่างได้เฉพาะตัวเลขข้อมูลจาก seed + สิ่งที่ Wei อนุมัติผ่าน BLOCKERS) | P0-QA-01 | G5 harness รันได้ + รายงาน diff อ่านได้ | 3 ชม. |
