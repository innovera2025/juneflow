...
| P0-FIX-03 | web | ready | **WEB-06 audit:** (1) ลบ comment เท็จ 2 จุดใน `api-client.ts` (อ้าง vite proxy ที่ยังไม่มี) (2) cookie auth ขัด contract ที่ประกาศ bearer JWT → **ต้องตัดสินก่อนจอ authenticated แรก — ดู B-028** | — (B-028 ตอบแล้ว ก) | CI + comment ตรงจริง + auth mode ตรง contract | 2 ชม. |
